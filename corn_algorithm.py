...
if __name__ == '__main__':
    ...
    # Plot the portfolio weights for all iterations as a stacked bar chart. 
    # For the order of assets use the order of the columns in log_returns.
    
    # create a dataframe with the portfolio weights
    df = pd.DataFrame.from_dict(portfolio_weights, orient='index', columns=df.columns)
    ...
    plt.savefig(f'output/weights_{t}.png')
